...
# ---------------------------------------------------------------------------
$GITHUB_OWNER = "Manuelr2000"
$GITHUB_REPO  = "Soporte_auto"

# Patron de nombre de asset por arquitectura.
# Usa {VERSION} como marcador; se sustituye por el numero real de version.
$ASSET_PATTERN = @{
    "x64"   = "Soporte_auto-{VERSION}-win-x64.exe"
    "x86"   = "Soporte_auto-{VERSION}-win-x86.exe"
    "arm64" = "Soporte_auto-{VERSION}-win-arm64.exe"
}
